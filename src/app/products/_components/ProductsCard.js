      ...
      <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 ease-in-out duration-300">
        ...
        <div className="p-5">
          <div className="flex items-center justify-between mb-2">
            <span className="bg-blue-100 text-blue-800 text-xs font-medium w-24 me-2 px-2.5 py-0.5 rounded-sm dark:bg-blue-900 dark:text-blue-300 truncate">
              Rs : {product.price}
            </span>
            ...
            <span className="bg-blue-100 text-yellow-800 text-xs font-medium w-24 me-2 px-2.5 py-0.5 rounded-sm dark:bg-yellow-900 dark:text-yellow-300 truncate">
              {product.category}
            </span>
          </div>
          <Link href={`/products/${product.id}`}>
          ...
          <button className="ms-2 w-[22%]  px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            &hearts;
          </button>
        </div>
      </div>
